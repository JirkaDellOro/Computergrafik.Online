(function($) {    
    ...
    $.anwidget("an.RadioButton", {
		...
		_attrs: ["id", "name", "disabled", "class"],
		getCreateOptions: function() {
			return $.extend(this.options, { 'id': "radiobutton" + _widgetID++ });
		},
		getCreateString: function() {
			return "<div><input type='radio' id='" + this._options['id'] + "'><label for='" + this._options['id'] + "'></label></div>";
		},
