...
lib.ssMetadata = [
		{name:"mobile_mixcolormode_atlas_", frames: [[0,0,1920,1080]]}
];
...
(lib._1 = function() {
	this.initialize(ss["mobile_mixcolormode_atlas_"]);
	this.gotoAndStop(0);
...
// stage content:
(lib.mobile_mixcolormode = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
	...
	this.hardlight.setTransform(494.65,859.45,2.8293,2.8293);
	...
	this.screen.setTransform(494.65,783.1,2.8293,2.8293);
	...
	this.darken.setTransform(636.1,966.9,2.8293,2.8293,0,0,0,50,11);
	...
	this.softlight.setTransform(316,966.9,2.8293,2.8293,0,0,0,50,11);
	...
	this.multiply.setTransform(316,890.55,2.8293,2.8293,0,0,0,50,11);
	...
	this.normal.setTransform(174.55,783.1,2.8293,2.8293);
...
p.nominalBounds = new cjs.Rectangle(334.1,636.1,819.8000000000001,599.6999999999999);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/mobile_mixcolormode_atlas_.png", id:"mobile_mixcolormode_atlas_"},
