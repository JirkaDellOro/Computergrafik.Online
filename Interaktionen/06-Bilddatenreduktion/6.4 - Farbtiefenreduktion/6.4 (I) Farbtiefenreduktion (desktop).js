...
lib.ssMetadata = [
		{name:"6.4 _I_ Farbtiefenreduktion _desktop__atlas_", frames: [[928,632,926,630],[0,632,926,630],[0,0,926,630],[0,1264,926,630],[928,0,926,630],[928,1264,926,630]]}
];
...
(lib.leaves_16_Bit = function() {
	this.spriteSheet = ss["6.4 _I_ Farbtiefenreduktion _desktop__atlas_"];
	this.gotoAndStop(0);
...
// stage content:
(lib._64IFarbtiefenreduktiondesktop = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
	...
	this.img_32.setTransform(433,369.3,0.864,0.862,0,0,0,463,326.7);
	this.img_32.alpha = 0;

	this.img_24 = new lib.img_24();
	this.img_24.name = "img_24";
	this.img_24.parent = this;
	this.img_24.setTransform(433,369.3,0.864,0.862,0,0,0,463,326.7);
	this.img_24.alpha = 0;

	this.img_16 = new lib.img_16();
	this.img_16.name = "img_16";
	this.img_16.parent = this;
	this.img_16.setTransform(433,369.3,0.864,0.862,0,0,0,463,326.7);
	this.img_16.alpha = 0;

	this.img_8 = new lib.img_8();
	this.img_8.name = "img_8";
	this.img_8.parent = this;
	this.img_8.setTransform(433,369.3,0.864,0.862,0,0,0,463,326.7);
	this.img_8.alpha = 0;

	this.img_4 = new lib.img_4();
	this.img_4.name = "img_4";
	this.img_4.parent = this;
	this.img_4.setTransform(433,369.3,0.864,0.862,0,0,0,463,326.7);
	this.img_4.alpha = 0;

	this.img_2 = new lib.img_2();
	this.img_2.name = "img_2";
	this.img_2.parent = this;
	this.img_2.setTransform(433,369.3,1.111,1.122,0,0,0,360,250.9);
...
p.nominalBounds = new cjs.Rectangle(513,447.8,800,853.9);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/6.4 _I_ Farbtiefenreduktion _desktop__atlas_.png?1551693688552", id:"6.4 _I_ Farbtiefenreduktion _desktop__atlas_"},
		{src:"https://code.jquery.com/jquery-2.2.4.min.js?1551693688561", id:"lib/jquery-2.2.4.min.js"},
		{src:"components/sdk/anwidget.js?1551693688561", id:"sdk/anwidget.js"},
		{src:"components/ui/src/css.js?1551693688561", id:"an.CSS"}
	],
	preloads: []
};
