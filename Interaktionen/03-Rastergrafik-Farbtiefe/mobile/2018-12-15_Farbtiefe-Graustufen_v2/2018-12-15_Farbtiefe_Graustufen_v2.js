...
// stage content:
(lib._20181215_Farbtiefe_Graustufen_v2 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
	...
	this.Bilder.setTransform(360.2,170.4,1,1,0,0,0,360.2,170.4);
	this.Bilder.depth = 0;
...
p.nominalBounds = new cjs.Rectangle(360,640,360.5,36.39999999999998);
// library properties:
lib.properties = {
