...
(lib._20181214_HTMLcomponents = function(mode,startPosition,loop) {
	...
	this.frame_0 = function() {
		...
		$('.radioContainer').append('<label class="container">Radio 1<input type="radio" id="bit1_radio" class="radioBtn" name="radio" value="1"  checked><span class="checkmark"></span></label></br></br>');
		$('.radioContainer').append('<label class="container">Radio 2<input type="radio" id="bit2_radio" class="radioBtn" name="radio" value="2"><span class="checkmark"></span></label></br></br>');
