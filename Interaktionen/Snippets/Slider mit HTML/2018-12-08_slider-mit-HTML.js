...
(lib.Szene_1_script = function(mode,startPosition,loop) {
	...
	this.myCss.setTransform(449.95,168.75,1,1,0,0,0,50,11);
...
// stage content:
(lib._20181208_slidermitHTML = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
	...
	this.script.setTransform(449.9,168.8,1,1,0,0,0,449.9,168.8);
	this.script.depth = 0;
...
p.nominalBounds = new cjs.Rectangle(674.5,357.3,-174,-177);
// library properties:
lib.properties = {
