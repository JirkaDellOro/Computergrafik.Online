	...
	this.frame_0 = function() {
		...
		function Transformation(val)
		{
			...
			if(val != 1)
			{
				...
				rectangle.scaleX = scaleXr * val;
				rectangle.scaleY = scaleYr * val;
				//rectangle.y = positionY+val*35;
			
			}
			else
			{
				rectangle.scaleX = scaleXr;
				rectangle.scaleY = scaleYr;
				jpgtest.y = positionY;
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/Transformationsverkettung_Int_atlas_.png?1547070857699", id:"Transformationsverkettung_Int_atlas_"},
		{src:"https://code.jquery.com/jquery-2.2.4.min.js?1547070857709", id:"lib/jquery-2.2.4.min.js"},
		{src:"components/sdk/anwidget.js?1547070857709", id:"sdk/anwidget.js"},
		{src:"components/ui/src/css.js?1547070857709", id:"an.CSS"}
	],
	preloads: []
};
