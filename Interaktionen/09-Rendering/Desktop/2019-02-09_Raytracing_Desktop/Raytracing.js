...
lib.ssMetadata = [
		{name:"Raytracing_atlas_", frames: [[0,722,960,720],[0,0,960,720]]}
];
...
(lib.Szene_1_Bilder = function(mode,startPosition,loop) {
	...
	this.img_0.setTransform(-284.9,0,1.3333,1.3333);

	this.img_1 = new lib.raytracing_1();
	this.img_1.name = "img_1";
	this.img_1.parent = this;
	this.img_1.setTransform(-284.9,0,1.3333,1.3333);
...
(lib.Raytracing = function(mode,startPosition,loop) {
	...
	this.frame_0 = function() {
		...
		$('.buttonContainer').append('<label class="container">Shading<input type="radio" id="shading_radio" class="radioBtn" name="radio" value="0" checked><span class="radioCheckmark"></span></label></br></br>');
		$('.buttonContainer').append('<label class="container">Raytracing<input type="radio" id="raytracing_radio" class="radioBtn" name="radio" value="1"><span class="radioCheckmark"></span></label>');
	...
	this.Bilder.setTransform(195.1,415.8,1,1,0,0,0,195.1,415.8);
	this.Bilder.depth = 0;
...
p.nominalBounds = new cjs.Rectangle(195.1,360,480,509.5);
// library properties:
lib.properties = {
