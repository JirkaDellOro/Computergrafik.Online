...
(lib.v0101zahlensystem = function(mode,startPosition,loop) {
	...
	this.valueHex1.setTransform(545.9,569.6,0.6243,0.6245,0,0,0,66.5,31.9);
	...
	this.valueHex16.setTransform(450.2,569.55,0.6243,0.6245,0,0,0,66.5,31.8);
	...
	this.instance.setTransform(808.25,620.15,1,1,0,0,0,50,11);

	this.text = new cjs.Text("Hexadezimal-\nsystem", "50px 'Oswald'");
	this.text.lineHeight = 76;
	this.text.lineWidth = 284;
	this.text.parent = this;
	this.text.setTransform(26,551.95);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.text},{t:this.instance}]}).wait(1));

	// Binär
	this.text_1 = new cjs.Text("Binär", "50px 'Oswald'");
	this.text_1.lineHeight = 76;
	this.text_1.lineWidth = 284;
	this.text_1.parent = this;
	this.text_1.setTransform(26,332.05);
	...
	this.text_2.setTransform(167.95,42.35);
