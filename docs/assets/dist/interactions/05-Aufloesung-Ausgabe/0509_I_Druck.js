...
(lib.Szene_1_Actions = function(mode,startPosition,loop) {
	...
	// Actions
	this.customCSS = new lib.an_CSS({'id': 'customCSS', 'href':'assets/0509_I_Druck.css'});
...
// stage content:
(lib._0509_I_Druck = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
	...
	this.frame_0 = function() {
		...
		$('.radioContainer').append('<label class="container">Original<input type="radio" id="original_radio" class="radioBtn" name="radio" value="1"  checked><span class="radioCheckmark"></span></label></br></br>');
		$('.radioContainer').append('<label class="container">Amplitudenmoduliert gerastert<input type="radio" id="am_radio" class="radioBtn" name="radio" value="2"><span class="radioCheckmark"></span></label></br></br>');
		$('.radioContainer').append('<label class="container">Frequenzmoduliert gerastert<input type="radio" id="fm_radio" class="radioBtn" name="radio" value="3"><span class="radioCheckmark"></span></label></br></br>');
		//SLIDER
...
p.nominalBounds = new cjs.Rectangle(1258.4,628.5,-379.0000000000001,-255.7);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"https://code.jquery.com/jquery-2.2.4.min.js?1551185789906", id:"lib/jquery-2.2.4.min.js"},
		{src:"components/sdk/anwidget.js?1551185789906", id:"sdk/anwidget.js"},
		{src:"components/ui/src/css.js?1551185789906", id:"an.CSS"}
	],
	preloads: []
};
