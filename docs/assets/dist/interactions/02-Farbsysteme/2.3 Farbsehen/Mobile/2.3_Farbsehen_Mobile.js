...
lib.ssMetadata = [
		{name:"2.3_Farbsehen_Mobile_atlas_", frames: [[0,0,3375,5779],[0,5781,512,512]]}
];
...
(lib.roboter_transparent = function() {
	this.spriteSheet = ss["2.3_Farbsehen_Mobile_atlas_"];
	this.gotoAndStop(0);
...
// stage content:
(lib._23_Farbsehen_Mobile = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
	...
	// script
	this.instance = new lib.an_CSS({'id': '', 'href':'assets/componentsCss_Mobile.css'});

	this.instance.setTransform(658.1,858.4,1,1,0,0,0,50,11);
	...
	this.augeTwo.setTransform(631,432,0.892,0.86,0,0,0,10.3,22.7);
	...
	this.augeOne.setTransform(568.4,431.9,0.879,0.879,0,0,0,10.2,22.2);
	...
	this.paper.setTransform(341.3,662.6,0.86,0.86,0,0,0,195.9,23.4);

	this.timeline.addTween(cjs.Tween.get(this.paper).wait(1));

	// weißes Papier
	this.shape = new cjs.Shape();
	this.shape.graphics.f().s("#000000").ss(1,1,1).p("A6TiUMA0nAAAIAAEpMg0nAAAg");
	this.shape.setTransform(341.3,660.7);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#FFFFFF").s().p("A6TCVIAAkpMA0nAAAIAAEpg");
	this.shape_1.setTransform(341.3,660.7);
	...
	mask._off = true;
	mask.graphics.p("EgsZAekMAAAg9HMBYzAAAMAAAA9Hg");
	mask.setTransform(275.5,499.5);

	// Rot 2
	this.redlinetwo = new lib.redLineTwo();
	this.redlinetwo.name = "redlinetwo";
	this.redlinetwo.parent = this;
	this.redlinetwo.setTransform(472.9,529.5,0.86,0.86,0,0,0,131.8,130.9);
	...
	this.greenlinetwo.setTransform(461.2,529.3,0.86,0.86,0,0,0,131.8,130.9);
	...
	this.bluelinetwo.setTransform(448.8,529.5,0.86,0.86,0,0,0,131.8,130.9);
	...
	this.instance_1.setTransform(26,318,0.255,0.255);
	...
	mask_1._off = true;
	mask_1.graphics.p("Av9SbMAAAgk1If6AAMAAAAk1g");
	mask_1.setTransform(604.1,430.8);

	// Roboter
	this.instance_2 = new lib.roboter_transparent();
	this.instance_2.parent = this;
	this.instance_2.setTransform(450,321,0.09,0.09);
	...
	this.shape_2.graphics.f("#FFFFFF").s().p("AikAoIDMjMIB9B8IjMDNg");
	this.shape_2.setTransform(113.2,416.8);

	this.timeline.addTween(cjs.Tween.get(this.shape_2).wait(1));

	// Rot
	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f().s("#FF0000").ss(10,1,1).p("A0t0fMApbAo/");
	this.shape_3.setTransform(251.8,540.2);

	this.timeline.addTween(cjs.Tween.get(this.shape_3).wait(1));

	// Grün
	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f().s("#00FF00").ss(10,1,1).p("AyMx/MAkZAj/");
	this.shape_4.setTransform(229.7,530.6);

	this.timeline.addTween(cjs.Tween.get(this.shape_4).wait(1));

	// Blau
	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.f().s("#0000FF").ss(10,1,1).p("AxrxjMAjXAjH");
	this.shape_5.setTransform(219.9,532.9);

	this.timeline.addTween(cjs.Tween.get(this.shape_5).wait(1));

	// Ebene_2
	this.shape_6 = new cjs.Shape();
	this.shape_6.graphics.f("#F5F5F5").s().p("Eg41BjvMAAAjHdMBxrAAAMAAADHdg");
	this.shape_6.setTransform(361.3,640.1,0.986,1);

	this.timeline.addTween(cjs.Tween.get(this.shape_6).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(362.6,641.7,717.5,1276.7);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/2.3_Farbsehen_Mobile_atlas_.png?1551350244331", id:"2.3_Farbsehen_Mobile_atlas_"},
		{src:"https://code.jquery.com/jquery-2.2.4.min.js?1551350244348", id:"lib/jquery-2.2.4.min.js"},
		{src:"components/sdk/anwidget.js?1551350244348", id:"sdk/anwidget.js"},
		{src:"components/ui/src/css.js?1551350244348", id:"an.CSS"}
	],
	preloads: []
};
