...
lib.ssMetadata = [
		{name:"Projektions_Transformation_atlas_", frames: [[0,722,960,720],[0,0,960,720]]}
];
...
(lib.Szene_1_Bilder = function(mode,startPosition,loop) {
	...
	this.img_0.setTransform(312.45,360,1,1,0,0,0,480,360);
	...
	this.img_1.setTransform(312.45,360,1,1,0,0,0,480,360);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.img_1},{t:this.instance},{t:this.img_0}]}).wait(1));
...
(lib.ProjektionsTransformation = function(mode,startPosition,loop) {
	...
	this.frame_0 = function() {
		...
		$('.buttonContainer').append('<label class="container">orthgraphische Projektions-Transformation<input type="radio" id="raytracing_radio" class="radioBtn" name="radio" value="1"><span class="radioCheckmark"></span></label>');
	...
	this.Bilder.setTransform(312.4,415.8,1,1,0,0,0,312.4,415.8);
	this.Bilder.depth = 0;
...
p.nominalBounds = new cjs.Rectangle(192.5,640,600,229.5);
// library properties:
lib.properties = {
