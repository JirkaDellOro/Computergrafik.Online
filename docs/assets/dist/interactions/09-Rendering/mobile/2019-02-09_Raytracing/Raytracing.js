...
lib.ssMetadata = [
		{name:"Raytracing_atlas_", frames: [[0,0,960,720],[0,722,960,720]]}
];
...
(lib.raytracing = function() {
	this.initialize(ss["Raytracing_atlas_"]);
	this.gotoAndStop(0);
...
(lib.shading_Ebene_1 = function(mode,startPosition,loop) {
...
}).prototype = getMCSymbolPrototype(lib.shading_Ebene_1, null, null);


(lib.raytracing_Ebene_1 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});

	// Ebene_1
	this.instance = new lib.raytracing();
	this.instance.parent = this;
	this.instance.setTransform(0,0,0.75,0.75);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

}).prototype = getMCSymbolPrototype(lib.raytracing_Ebene_1, null, null);
...
(lib.Szene_1_Actions = function(mode,startPosition,loop) {
	...
	this.customCSS.setTransform(556.25,858,1,1,0,0,0,50,11);
...
(lib.shading_1 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});

	// Ebene_1_obj_
	this.Ebene_1 = new lib.shading_Ebene_1();
	this.Ebene_1.name = "Ebene_1";
	this.Ebene_1.parent = this;
	this.Ebene_1.setTransform(360,270,1,1,0,0,0,360,270);
...
}).prototype = getMCSymbolPrototype(lib.shading_1, new cjs.Rectangle(0,0,720,540), null);


(lib.raytracing_1 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});

	// Ebene_1_obj_
	this.Ebene_1 = new lib.raytracing_Ebene_1();
	this.Ebene_1.name = "Ebene_1";
	this.Ebene_1.parent = this;
	this.Ebene_1.setTransform(360,270,1,1,0,0,0,360,270);
	this.Ebene_1.depth = 0;
...
}).prototype = getMCSymbolPrototype(lib.raytracing_1, new cjs.Rectangle(0,0,720,540), null);
...
(lib.Szene_1_Bilder = function(mode,startPosition,loop) {
	...
	// Bilder
	this.img_0 = new lib.shading_1();
	this.img_0.name = "img_0";
	this.img_0.parent = this;
	this.img_0.setTransform(360,270,1,1,0,0,0,360,270);

	this.img_1 = new lib.raytracing_1();
	this.img_1.name = "img_1";
	this.img_1.parent = this;
	this.img_1.setTransform(360,270,1,1,0,0,0,360,270);
...
// stage content:
(lib.Raytracing = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
	...
	this.frame_0 = function() {
		...
		$('body').append('<div class="buttonContainer_left">')
		$('.buttonContainer_left').append('<label class="container">Shading<input type="radio" id="shading_radio" class="radioBtn" name="radio" value="0" checked><span class="radioCheckmark"></span></label></br></br>');
		$('body').append('<div class="buttonContainer_right">')
		$('.buttonContainer_right').append('<label class="container">Raytracing<input type="radio" id="raytracing_radio" class="radioBtn" name="radio" value="1"><span class="radioCheckmark"></span></label>');
	...
	this.Actions.setTransform(556.3,858,1,1,0,0,0,556.3,858);
	...
	this.Bilder.setTransform(360,415.8,1,1,0,0,0,360,415.8);
	this.Bilder.depth = 0;
...
p.nominalBounds = new cjs.Rectangle(360,640,360,229.5);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/Raytracing_atlas_.png", id:"Raytracing_atlas_"},
