...
(lib._20181219_1624_BitFarbtiefe_Desktop_v1 = function(mode,startPosition,loop) {
	...
	this.frame_0 = function() {
		...
		$('#animation_container').append('<div class="buttonContainer">')
		$('.buttonContainer').append('<label class="container">16 Bit<input type="radio" id="bit16_radio" class="radioBtn" name="radio" value="0" checked><span class="radioCheckmark"></span></label>');
