...
lib.ssMetadata = [
		{name:"Unterschied_Zu_Rastergrafiken_Int_M_atlas_", frames: [[0,0,1354,280],[1356,232,47,47],[1356,0,227,230]]}
];
...
(lib.CachedTexturedBitmap_10 = function() {
	this.initialize(ss["Unterschied_Zu_Rastergrafiken_Int_M_atlas_"]);
	this.gotoAndStop(0);
...
(lib.Szene_1_script = function(mode,startPosition,loop) {
	...
	// script
	this.myCss = new lib.an_CSS({'id': 'myCss', 'href':'\\ACER-DAVIDE\Users\Davide\Desktop\HFU\5. Semester\Projektstudium\fla-Files\07_Vektorgrafik\Interaktionen\RGvsVG\Mobile\assets\componentsCss.css'});
...
// stage content:
(lib.Unterschied_Zu_Rastergrafiken_Int_M = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
...
lib.properties = {
	...
	manifest: [
		...
		{src:"images/Unterschied_Zu_Rastergrafiken_Int_M_atlas_.png", id:"Unterschied_Zu_Rastergrafiken_Int_M_atlas_"},
		{src:"sounds/_070202wav.mp3", id:"_070202wav"},
