...
p.nominalBounds = new cjs.Rectangle(-481,-641,962,1282);
...
(lib.Szene_1_Actions = function(mode,startPosition,loop) {
	...
	// Actions
	this.instance = new lib.an_CSS({'id': '', 'href':'assets/0511_Rasterwinkelung_mobile.css'});
...
// stage content:
(lib._0511_I_Rasterwinkelung_mobile = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
	...
	this.frame_0 = function() {
		...
		$('.sliderContainer_b').append('<span id="slider_value_b">0</span> °');
		//MAGENTA
		...
		$('.sliderContainer_m').append('<span id="slider_value_m">0</span> °');
		//GELB
		...
		$('.sliderContainer_y').append('<span id="slider_value_y">0</span> °');
		//CYAN
		...
		$('.sliderContainer_c').append('<span id="slider_value_c">0</span> °');
	...
	this.___camera___instance.setTransform(480,640);
...
p.nominalBounds = new cjs.Rectangle(479,639,482,642);
// library properties:
lib.properties = {
